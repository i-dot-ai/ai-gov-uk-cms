...
module.exports = (eleventyConfig) => {
    ...
    eleventyConfig.on("eleventy.before", async ({ dir, runMode, outputMode }) => {
        ...
        const assets = await axios.get(`https://api.github.com/repos/${CMS_REPO}/contents/static/images/uploads`, {
            headers: {
        ...
        for (const asset of assets.data) {
            ...
            const localFilePath = path.resolve(__dirname, `${ASSETS_FOLDER}/${asset.name}`);
